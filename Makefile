# venv_path := ~/.venv/todo
venv_path := /home/paulo/project-python-django/restapi-todo-app/venv
...
run:
	...
	${bin_path}/gunicorn project.wsgi:application --bind localhost:8080

shell:
	@echo 'To activate the venv use source ~/.venv/todo/bin/activate . Use deactivate to exit'
